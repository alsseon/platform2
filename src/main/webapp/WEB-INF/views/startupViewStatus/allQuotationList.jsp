...
<body>
	...
	<table class="table">
		<tr>
			...
			<c:forEach var="list" begin="0" end="2" items="${allQuotationList}">
	...
	<a href = "${contextPath}/startupViewStatus/quotationList_Waiting.do?compId=${member.id}">더보기</a>
	<h1>진행중인 견적</h1>
	<table class="table">
		<tr>
			<th>번호</th>
